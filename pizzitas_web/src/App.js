    ...
    const Wrapper = (props) => {
        ...
        switch(props.path){
            ...
            case "productosManagement":
                return (
                    <EditProducto {...{...props, match: {params}}}/>
                )
                break;
            default:
                break;
    ...
    return (
        <React.Fragment>
                ...
                <Navbar expand="lg" className="navheader">
                    <div className="collapse navbar-collapse">
                        <ul className="navbar-nav">
                            ...
                            <NavItem>
                            <Link to={'/productosManagement'} className="nav-link">Productos Management</Link>
                            </NavItem>
                            <NavItem>
                                <Link to={'/ordenesManagement'} className="nav-link">Ordenes Management</Link>
                            </NavItem>
                        </ul>
                    </div>
                    {
            ...
            <Routes>
                ...
                <Route exact path='/edit/:id' element={<Wrapper token={token} path={"employeesManagement"} />} replace to='employeesManagement' />

                {/* Productos */}
                <Route exact path='/productosManagement' element={<ProductoManagement token={token} />} />
                <Route exact path='/addProducto' element={<AddProducto token={token} replace to='productosManagement' />} />
                <Route exact path='/edit/producto/:id' element={<Wrapper token={token} path={"productosManagement"} />} replace to='productosManagement' />
                
                
                {/*  Ordenes */}
                <Route exact path='/ordenesManagement' element={<OrdenesManagement/>  } />
